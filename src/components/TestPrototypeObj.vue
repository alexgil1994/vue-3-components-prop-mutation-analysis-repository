<!-- <template> -->
<!-- <input v-model="localDto.name" type="text" /> -->
<!-- <input :value="localDto.name" type="text" @input="($e) => triggerUpdate()" /> -->
<!-- </template> -->
...
const emits = defineEmits(["update-dto"]);

const localDto = computed(() => props.dto);
